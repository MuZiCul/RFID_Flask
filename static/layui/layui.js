    ...
    var r = document, u = "getElementById", c = "getElementsByTagName", a = "layui-disabled", t = function (e) {
        ...
        var i, e, t, n = this.config, r = n.groups = "groups" in n ? Number(n.groups) || 0 : 5,
            ...
            l = {
                ...
                count: '<span class="layui-laypage-count">' + (e = "object" == typeof n.countText ? n.countText : ["Total ", " Article"])[0] + n.count + e[1] + "</span>",
                limit: (i = ['<span class="layui-laypage-limits"><select lay-ignore>'], layui.each(n.limits, function (e, a) {
                    var t;
                    i.push('<option value="' + a + '"' + (a === n.limit ? " selected" : "") + ">" + (t = (a = a) + " Article/Page", "function" == typeof n.limitTemplet && n.limitTemplet(a) || t) + "</option>")
                }), i.join("") + "</select></span>"),
                refresh: ['<a data-page="' + n.curr + '" class="layui-laypage-refresh">', '<i class="layui-icon layui-icon-refresh"></i>', "</a>"].join(""),
                skip: ['<span class="layui-laypage-skip">' + (e = "object" == typeof n.skipText ? n.skipText : ["To", "Page", "Confirm"])[0], '<input type="text" min="1" value="' + n.curr + '" class="layui-input">', e[1] + '<button type="button" class="layui-laypage-btn">' + e[2] + "</button>", "</span>"].join("")
            };
...
layui.define(["jquery", "lay"], function (e) {
    "use strict";
    var k = layui.$, t = layui.lay, o = layui.hint(), i = layui.device().mobile ? "click" : "mousedown", n = {
        ...
        }, H = k(window), s = k(document), d = function (e) {
    ...
    d.prototype.config = {
        ...
        var o = k(['<div class="layui-unselect layui-colorpicker">', "<span " + ("rgb" == i.format && i.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : "") + ">", '<span class="layui-colorpicker-trigger-span" ', 'lay-type="' + ("rgb" == i.format ? i.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + (o = "", i.color ? (o = i.color, 3 < (i.color.match(/[0-9]{1,3}/g) || []).length && (i.alpha && "rgb" == i.format || (o = "#" + F(Y(L(i.color))))), "background: " + o) : o) + '">', '<i class="layui-icon layui-colorpicker-trigger-i ' + (i.color ? x : P) + '"></i>', "</span>", "</span>", "</div>"].join("")),
            r = i.elem = k(i.elem);
        ...
        k(a)[0] && k(a).data("index") == e.index ? e.removePicker(d.thisElemInd) : (e.removePicker(d.thisElemInd), k("body").append(t)), n.thisId = i.id, d.thisElemInd = e.index, d.thisColor = r.style.background, e.position(), e.pickerEvents()
        ...
        d = p(window), F = p(document), i = function (e) {
            ...
            var e = this.config,
                ...
                i = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = p(e.toolbar).html() || "") && a.html(m(t).render(e)), {
                    ...
                    exports: {title: "Export", layEvent: "LAYTABLE_EXPORT", icon: "layui-icon-export"},
                    print: {title: "Print", layEvent: "LAYTABLE_PRINT", icon: "layui-icon-print"}
                }), l = [];
                    ...
                    switch (layui.stope(e), F.trigger("table.tool.panel.remove"), f.close(s.tipsIndex), t) {
                        ...
                        case"LAYTABLE_EXPORT":
                            ...
                            b.ie ? f.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", this, {tips: 3}) : n({
                                list: ['<li data-type="csv">Export the CSV file</li>', '<li data-type="xls">Export the XLS file</li>'].join(""),
                                done: function (e, t) {
                                    t.on("click", function () {
...
layui.define(["form", "util"], function (e) {
    ...
    l.prototype.config = {
        ...
        isJump: !1,
        edit: !1,
        text: {defaultNodeName: "\u672a\u547d\u540d", none: "No data"}
